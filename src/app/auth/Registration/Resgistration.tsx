...
function Resgistration() {
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="auth-resgitration">
      ...
      >
        ...
        />
        <div onClick={() => toogleActiveEye("isActiveEye", "#passInput")}>
          {!isActiveEye ? (
            <img
              src={
                import.meta.env.VITE_PUBLIC_URL + "images/login/small_eye.svg"
              }
              className="small-eye"
            />
          ) : (
            <img
              src={
                import.meta.env.VITE_PUBLIC_URL + "images/login/active_eye.svg"
              }
              className="small-eye"
            />
          )}
        ...
        {formik.errors.password && formik.touched.password ? (
          <div className="mess-invalid mt-1">{formik.errors.password}</div>
        ) : null}
      </div>
      <div
        data-mdb-input-init
      ...
      >
        ...
        />
        <div
          onClick={() => toogleActiveEye("isActiveEyeAgain", "#rePassInput")}
        >
          {!isActiveEyeAgain ? (
            <img
              src={
        ...
        {formik.errors.rePassword && formik.touched.rePassword ? (
          <div className="mess-invalid mt-1">{formik.errors.rePassword}</div>
        ) : null}
      </div>
